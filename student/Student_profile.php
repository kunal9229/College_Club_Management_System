    ...
    <div class="row">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <form action="Student_logic.php" method="post">
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Name</label><input type="text" name="name" class="form-control" value="<?php echo $q['name']; ?>"></div>
                    ...
                    <div class="col-md-12"><label class="labels">Mobile Number</label><input type="text" name="phno" class="form-control" value="<?php echo $q['phno']; ?>"></div>
                    <input type="hidden" name="id" value="<?php echo $q['id']; ?>">
                </div>
                <div class="row mt-3">
                    <div class="col-md-6"><label class="labels">Collage ID</label><input type="text" disabled name="city" class="form-control" value="<?php echo $q['collage_id']; ?>"></div>
                    <div class="col-md-6"><label class="labels">Collage Name</label><input type="text" disabled name="state" class="form-control" value="
                    <?php
                        $Cemail = $q["collage_email"];
                        $sql1 = "SELECT * FROM collage where email = '$Cemail'";
