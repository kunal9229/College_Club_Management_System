    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <h1 class="mx-5"><?php echo $q['name']; ?></h1>
          <li><a href="Student_main.php" class="nav-link px-2 mt-3 link-secondary">Home</a></li>
          <!-- <li><a href="#" class="nav-link px-2 link-body-emphasis">Club</a></li> -->
          <!-- <li><a href="#" class="nav-link px-2 link-body-emphasis">Customers</a></li>
          <li><a href="#" class="nav-link px-2 link-body-emphasis">Products</a></li> -->
        </ul>

        <form class="d-flex mx-3" action="Student_logic.php" method="POST">
        <input class="form-control me-2" type="search" name="search" placeholder="Search Post" aria-label="Search">
        <button class="btn btn-outline-success" type="submit"><i class="bi bi-search"></i></button>
      </form>
        <?php
        	
          $grav_url = "https://www.gravatar.com/avatar/" . md5( strtolower( trim( $_SESSION['email'] ) ) ) . "?d=" . urlencode( 'mp' ) . "&s=40";
